...
public class DataController implements Runnable {
    ...
    public void run() {
        ...
        while (true) {
            ...
            if (dataType.equals("" + Constants.have) && position != 14) {
                Peer2Peer.logger.logDisplay(Peer2Peer.ID_peer + " Peer sent HAVE " + currentID_peer);
                ...
                switch (position) {
                    ...
                    case 3:
                        ...
                        if (dataType.equals("" + Constants.Interested)) {
                            Peer2Peer.logger
                                    .logDisplay(Peer2Peer.ID_peer + " received REQUEST message to Peer " + currentID_peer);
                            Peer2Peer.logger
                                    .logDisplay(
                                            Peer2Peer.ID_peer + " Peer sent INTERESTED  " + currentID_peer);
                            ...
                            Peer2Peer.logger.logDisplay(
                                    Peer2Peer.ID_peer + " Peer sent NOT INTERESTED message " + currentID_peer);
    ...
    private void sendHaveMessage(String pId, Socket socket) {
        Peer2Peer.logger.logDisplay(Peer2Peer.ID_peer + " sent HAVE message to Peer " + pId);
        sendOutput(MessageInfo.array_DataToByte(
