        ...
        try
        {
            ...
            else
            {
                ...
                for(Map.Entry<String,RemotePeerData> hashMap: peerdatahashMap.entrySet() )
                {
                    ...
                    {
                        PeerController p=new PeerController(RemotePeerData.getPeerAddress(),Integer.parseInt(RemotePeerData.getPeerPort()),1, ID_peer);
    ...
    public static void obtainConfigData() throws IOException {
        ...
        try
        {
            ...
            while((configurations=b.readLine())!=null)
            {
                ...
                String[] line=configurations.split(" ");
                if(line[0].trim().equals("preferredNumberTotal"))
                {
                    Constants.preferredNumberTotal=Integer.parseInt(line[1]);
                }
    ...
    public static class SetPreferredNeighbours extends TimerTask {
        public void run() {
            ...
            while(remoteID_peers.hasMoreElements()) {
                ...
                if(remoteID_peer.equals(ID_peer)) continue;
            ...
            if(interestedPeers > Constants.piece)
            {
                ...
                {
                    if (Total > Constants.preferredNumberTotal - 1) break;
                            ...
                            && peerdatahashMap.get(RemotePeerData.ID_Peer).isCompleted == 0)
                    {
                        ...
                        dataPrefNeighbourhashMap.put(RemotePeerData.ID_Peer, peerdatahashMap.get(RemotePeerData.ID_Peer));
                        Total++;
            ...
            else
            {
                ...
                while(remoteID_peers.hasMoreElements())
                {
                    ...
                    if(nextID_peer.equals(ID_peer)) continue;
